...
def train(args):
    ...
    while should_keep_training:
        ...
        for i_batch, data_blob in enumerate(train_loader):
            ...
            # if args.add_noise:
            # show_image(image1[0,:,:,:],'2-image0.png')
            ...
            image1 = (image1 + stdv * torch.randn(*image1.shape).cuda()).clamp(0.0, 120.0)
            image2 = (image2 + stdv * torch.randn(*image2.shape).cuda()).clamp(0.0, 120.0)
            ...
            flow_predictions = model(image1, image2,depth1,depth2, iters=args.iters)
